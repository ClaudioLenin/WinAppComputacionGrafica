...
{
    internal class MediaCircunferencia
    {
        public double x0;
        public double y0;
        public double radio;
        ...
        public MediaCircunferencia(double x0, double y0, double radio, double angulo, Color color0, Bitmap lienzo, PictureBox pbxVentana)
        {
            this.x0 = x0;
            this.y0 = y0;
            this.radio = radio;
